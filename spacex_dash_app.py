...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        spacex_df_pie=spacex_df[spacex_df["Launch Site"]==entered_site].value_counts("class") 
        spacex_df_pie=spacex_df_pie.reset_index()
        fig = px.pie(spacex_df_pie, values='count', 
        names='class', 
